...
public class ScanNumberShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_number_show);
        initViews();
        initImage();
    }
...
//        mNalBitmap = BitmapFactory.decodeResource(getResources(),R.drawable.test);
    ...
    private void initViews() {
        mPhotoView = findViewById(R.id.photo_view_number_show);
        mBackBtn = findViewById(R.id.ib_number_show_back);
