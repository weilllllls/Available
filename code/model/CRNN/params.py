...
nc = 1
pretrained = 'checkpoint/110w/netCRNN_0_420_0.7867457301051051.pth' # path to pretrained model (to continue training)
output_dir = 'output/2k/2'
expr_dir = 'output/crnn/2k/2' # where to store samples and models
...
valInterval = 16 # interval to val the model loss and accuray
saveInterval = 16 # interval to save model
